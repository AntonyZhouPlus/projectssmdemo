		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li><a href="${pageContext.request.contextPath}/product/findAll.do">产品数据管理</a></li>
							...
							<ul class="pagination">
								...
								<c:forEach begin="1" end="${pageInfo.pages}" var="page">
									<c:if test="${pageInfo.pageNum == page}">
										<li class="active"><a href="${pageContext.request.contextPath}/product/findAll.do?page=${page}&pageSize=${pageInfo.pageSize}">${page}</a></li>
									</c:if>
									<c:if test="${pageInfo.pageNum != page}">
										<li><a href="${pageContext.request.contextPath}/product/findAll.do?page=${page}&pageSize=${pageInfo.pageSize}">${page}</a></li>
									</c:if>
								</c:forEach>
